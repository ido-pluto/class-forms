...
import BaseLayout, {UseMiddlewareCallback} from '../base-layout.js';
...
export class EvalPage {
    ...
    private async _render() {
        try {
            ...
            if (response?.prototype instanceof BaseLayout) {
                this.req.method = 'GET';
                this.req.body = {};
                await new EvalPage(this.req, this.res, this.next, response).flow();
                return;
            }
